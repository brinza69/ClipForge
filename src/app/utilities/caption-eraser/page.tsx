...
import {
  Download, Eraser, Loader2, Upload, X, ArrowLeft,
  Wand2, Zap, AlertCircle, CheckCircle2,
} from "lucide-react";
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_320px]">
          ...
          <Card className="p-4 border-border/40 bg-card/60 space-y-3">
            ...
            <p className="text-[11px] text-muted-foreground text-center">
              Drag mask to reposition · drag corner to resize · or use sliders →
            </p>
          ...
          <div className="space-y-4">
            ...
            {resultUrl && (
              <div className="space-y-2">
                <Button className="w-full gap-2" onClick={downloadResult}>
                  <Download className="h-4 w-4" /> Download result
                </Button>
                <Button
                  variant="outline"
                  className="w-full gap-2"
                  onClick={() => { setResultUrl(""); setResultName(""); setErrorMsg(""); }}
                >
