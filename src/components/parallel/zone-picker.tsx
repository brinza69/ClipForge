...
export function ZonePicker({
  ...
  return (
    <Card className="p-4 space-y-3 border-border/40">
      ...
      {/* w-full is load-bearing: with only mx-auto the div shrinks to fit its
          content, and the aspect-ratio box below derives its width FROM this
          div — circular → 0px. The old <img> had an intrinsic width that
          masked this. */}
